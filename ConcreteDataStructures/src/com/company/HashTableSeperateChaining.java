...
class Entry<K, V> {
    ...
    //We are not overriding the object equals method .No casting is required with this method
...
public class HashTableSeperateChaining<K, V> implements Iterable<K> {
    ...
    //Converts a hash value to an index , essentially, this strips the negative sign and places the hash value in the domain[0, capacity
    ...
    //Returns true/false depending on whether a key is in the hashtable
    ...
    //Gets a key's values from the map and returns the value.Note: returns null if the value is null AND also returns
    ...
    //Removes an entryfrom a given bucket if it exists
    ...
    //Inserts an entry in a given bucket only if the entry does not already exist in the given bucket, but if it does
    // then update the entry value
    ...
    //Find and returns a particular entry in a given bucket if it exists, returns null otherwise
    ...
    //Returns the List of values found within the hash
    ...
    //Return an iterator to iterator over all the keys in this map
    @Override public java.util.Iterator <K> iterator(){
        ...
        return new java.util.Iterator<K>(){
            ...
            @Override public boolean hasNext(){
                ...
                //No iterator of the current iterator is empty
    ...
    //Returns a string represantation of this hash table
